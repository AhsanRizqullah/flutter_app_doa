...
baseTextStyle.copyWith(fontSize: 20.0, fontWeight: FontWeight.bold, wordSpacing: 2);

final doaArabTextStyle =
    baseTextStyle.copyWith(fontSize: 24, color: Colors.black,);

final doaArtiTextStyle =
baseTextStyle.copyWith(fontSize: 10, color: Colors.black,);